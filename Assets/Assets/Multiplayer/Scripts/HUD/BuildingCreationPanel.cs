...
public class BuildingCreationPanel : MonoBehaviour
{
	...
	public void Init(TownCenter ownerPlayer, BuildingProperties buildingProperties)
	{
	...
	{
		OwnerPlayer.CreateBuildingCmd(BuildingProperties.buildingPrefab.name);
